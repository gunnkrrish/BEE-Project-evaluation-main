...
export const getEmptyCardMessage = (filterType) =>{
    switch (filterType) {
        ...
        case "date":
            return `No stories found in given data range`;
        default:
            return `Start creating your first Travel Story ! Click the 'Add' button to add your thought , ideas, and memories . Let's get started! `;
    }
};
